...
function ( cat_1, a_1, b_1, alpha_1 )
    ...
    hoisted_8_1 := [ 0, 1 ];
    hoisted_7_1 := [ 1, Length( Range( alpha_1 ) ) ];
    ...
    hoisted_6_1 := [ List( deduped_11_1, function ( logic_new_func_x_2 )
            ...
            end ), List( deduped_11_1, function ( logic_new_func_x_2 )
                return REM_INT( QUO_INT( logic_new_func_x_2, hoisted_3_1 ), hoisted_5_1 );
            end ) ];
    hoisted_10_1 := List( deduped_11_1, function ( logic_new_func_x_2 )
            local hoisted_1_2;
            hoisted_1_2 := 1 + logic_new_func_x_2;
            return hoisted_9_1[1 + Sum( hoisted_8_1, function ( j_3 )
                       local deduped_1_3;
                       deduped_1_3 := (1 + j_3);
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_11_1 := deduped_12_1 ^ deduped_13_1;
    ...
    hoisted_5_1 := List( deduped_10_1, function ( logic_new_func_x_2 )
            return REM_INT( logic_new_func_x_2, hoisted_4_1 );
        end );
    hoisted_3_1 := Length( deduped_10_1 );
    return List( [ 0 .. deduped_11_1 - 1 ], function ( i_2 )
            local hoisted_1_2;
            hoisted_1_2 := [ ListWithIdenticalEntries( hoisted_3_1, i_2 ), hoisted_5_1 ];
            return CreateCapCategoryMorphismWithAttributes( cat_1, arg2_1, arg3_1, AsList, List( hoisted_9_1, function ( logic_new_func_x_3 )
                      local hoisted_1_3;
                      hoisted_1_3 := 1 + logic_new_func_x_3;
                      return hoisted_8_1[1 + Sum( hoisted_7_1, function ( j_4 )
                                 local deduped_1_4;
                                 deduped_1_4 := (1 + j_4);
                                 return hoisted_1_2[deduped_1_4][hoisted_1_3] * hoisted_6_1[deduped_1_4];
                             end )];
                  end ) );
        end );
end
...
function ( cat_1, l_1, m_1 )
    ...
    deduped_47_1 := [ 0, 1 ];
    deduped_46_1 := [ 1 ];
    deduped_45_1 := Range( m_1 );
    deduped_44_1 := Length( Source( l_1 ) );
    deduped_43_1 := Length( Source( m_1 ) );
    deduped_42_1 := Length( deduped_45_1 );
    deduped_41_1 := [ 0 .. deduped_42_1 - 1 ];
    deduped_40_1 := [ 0 .. deduped_43_1 * deduped_44_1 - 1 ];
    deduped_39_1 := [ 0 .. deduped_43_1 * deduped_43_1 - 1 ];
    hoisted_2_1 := [ 1, 2 ];
    hoisted_1_1 := [ deduped_46_1, deduped_46_1 ];
    hoisted_3_1 := Sum( deduped_47_1, function ( j_2 )
            local deduped_1_2;
            deduped_1_2 := 1 + j_2;
            return hoisted_1_1[deduped_1_2][1] * hoisted_2_1[deduped_1_2];
        end );
    deduped_38_1 := Filtered( [ 0, 1, 2, 3 ], function ( x_2 )
            return function (  )
                      if (x_2 = hoisted_3_1) then
                          return 1;
                      else
                          return 0;
                      fi;
    ...
    deduped_37_1 := Filtered( deduped_39_1, function ( x_2 )
            return REM_INT( x_2, hoisted_4_1 ) = REM_INT( QUO_INT( x_2, hoisted_4_1 ), hoisted_4_1 );
        end );
    hoisted_13_1 := AsList( l_1 );
    hoisted_12_1 := deduped_44_1;
    deduped_36_1 := Filtered( deduped_40_1, function ( x_2 )
            return REM_INT( x_2, hoisted_4_1 ) = hoisted_13_1[1 + REM_INT( QUO_INT( x_2, hoisted_4_1 ), hoisted_12_1 )];
        end );
    deduped_35_1 := Length( deduped_36_1 );
    deduped_34_1 := [ 0 .. Length( deduped_37_1 ) - 1 ];
    deduped_33_1 := [ 0 .. deduped_35_1 - 1 ];
    deduped_32_1 := [ 0 .. deduped_35_1 * deduped_44_1 - 1 ];
    hoisted_15_1 := deduped_40_1;
    hoisted_14_1 := deduped_36_1;
    hoisted_17_1 := List( deduped_33_1, function ( logic_new_func_x_2 )
            return REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_15_1[1 + hoisted_14_1[(1 + logic_new_func_x_2)]] ), hoisted_4_1 ), hoisted_12_1 );
        end );
    hoisted_16_1 := deduped_35_1;
    deduped_30_1 := Filtered( deduped_32_1, function ( x_2 )
            return hoisted_17_1[1 + REM_INT( x_2, hoisted_16_1 )] = REM_INT( QUO_INT( x_2, hoisted_16_1 ), hoisted_12_1 );
        end );
    deduped_29_1 := [ 0 .. Length( deduped_30_1 ) - 1 ];
    hoisted_26_1 := [ function (  )
                if 0 in deduped_38_1 then
                    return 1;
                else
                    return 0;
                fi;
    ...
    hoisted_25_1 := deduped_41_1;
    hoisted_24_1 := deduped_42_1;
    hoisted_7_1 := AsList( m_1 );
    hoisted_20_1 := List( deduped_33_1, function ( logic_new_func_x_2 )
            return hoisted_7_1[1 + REM_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_15_1[(1 + hoisted_14_1[(1 + logic_new_func_x_2)])] ), hoisted_4_1 )];
        end );
    hoisted_19_1 := deduped_32_1;
    hoisted_18_1 := deduped_30_1;
    hoisted_21_1 := [ List( deduped_29_1, function ( logic_new_func_x_2 )
                return hoisted_20_1[1 + REM_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_19_1[(1 + hoisted_18_1[(1 + logic_new_func_x_2)])] ), hoisted_16_1 )];
            end ), ListWithIdenticalEntries( Length( deduped_29_1 ), 0 ) ];
    hoisted_10_1 := deduped_47_1;
    hoisted_9_1 := [ 1, deduped_42_1 ];
    hoisted_22_1 := List( deduped_29_1, function ( i_2 )
            ...
            return Sum( hoisted_10_1, function ( j_3 )
                    local deduped_1_3;
                    deduped_1_3 := 1 + j_3;
                    return hoisted_21_1[deduped_1_3][hoisted_1_2] * hoisted_9_1[deduped_1_3];
                end );
        end );
    hoisted_6_1 := deduped_39_1;
    hoisted_5_1 := deduped_37_1;
    hoisted_8_1 := [ List( deduped_34_1, function ( logic_new_func_x_2 )
                return hoisted_7_1[1 + REM_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_6_1[(1 + hoisted_5_1[(1 + logic_new_func_x_2)])] ), hoisted_4_1 )];
            end ), ListWithIdenticalEntries( Length( deduped_34_1 ), 0 ) ];
    ...
    hoisted_23_1 := [ List( deduped_41_1, function ( x_2 )
                ...
                return;
            end ), List( deduped_41_1, function ( x_2 )
                if x_2 in hoisted_22_1 then
                    return 1;
                else
                    return 0;
                fi;
    ...
    deduped_31_1 := Filtered( deduped_41_1, function ( x_2 )
            local hoisted_1_2;
            hoisted_1_2 := 1 + CAP_JIT_INCOMPLETE_LOGIC( hoisted_25_1[(1 + REM_INT( x_2, hoisted_24_1 ))] );
            return hoisted_26_1[1 + Sum( hoisted_10_1, function ( j_3 )
                         local deduped_1_3;
                         deduped_1_3 := (1 + j_3);
                         return hoisted_23_1[deduped_1_3][hoisted_1_2] * hoisted_2_1[deduped_1_3];
                     end )] = 1;
        end );
    hoisted_27_1 := deduped_31_1;
    deduped_28_1 := SSortedList( List( [ 0 .. Length( deduped_31_1 ) - 1 ], function ( logic_new_func_x_2 )
              return REM_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_25_1[1 + REM_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_25_1[(1 + hoisted_27_1[(1 + logic_new_func_x_2)])] ), hoisted_24_1 )] ), hoisted_24_1 );
          end ) );
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, Length, Length( deduped_28_1 ) ), deduped_45_1, AsList, deduped_28_1 );
end
########
